...
EMPTY_SPOUSE_SLOT = 65535
SPOUSE_PREFIX = 8192
SPOUSE_PREFIX_MASK = 65280
SPOUSE_ID_MASK = 127

def spouse_slot_code(barmaid_id):
...
def spouse_barmaid_id(slot_code):
...
def read_spouse_barmaid_id(buffer):
...
def write_spouse_barmaid_id(buffer, barmaid_id):
